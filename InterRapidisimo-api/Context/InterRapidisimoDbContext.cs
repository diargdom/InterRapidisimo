...
namespace InterRapidisimo_api.Context
{
    public class InterRapidisimoDbContext : DbContext
    {
        public InterRapidisimoDbContext(DbContextOptions<InterRapidisimoDbContext> options) : base(options) { }
